...
import in.conceptarchitect.swt.AboutScreen;
...
public class TodoMainScreen implements UIBuilder {
	...
	private void buildMenu(Composite parent) {
		...
		MenuItem aboutBarFile= new MenuItem(menuBar, SWT.CASCADE);
		aboutBarFile.setText("&About");
		
		aboutBarFile.addListener(SWT.Selection, new Listener() {
